    ...
    chooseImage(id, index){
      uni.chooseImage({
        ...
        success:(res) => {
          ...
          let token = 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJyZWFsTmFtZSI6IuawkemaviIsInN1YiI6Im1pbiIsInN0YW1wIjoiZGE3NWE4ZTUyY2UwNGNjZWIzMTdhODVkMTVkNjUyZGIiLCJpZCI6MSwiZXhwIjoxNjIyMDA1NTA5LCJpYXQiOjE2MjE0MDA3MDl9.CIqSoa2WiHjfTcZk33iHqG7mQVnxmuritRMQ7cMpodU__Rj2lxSesG7CUGPoksVsbFMYpj8ZvnjSF4p5psoDHw'
          uni.uploadFile({
            file: tempFile,
            header:{
              authorization: token
            ...
            name:"image",
            url: "http://localhost:8101/album/addImage",
            success:(res) => {
